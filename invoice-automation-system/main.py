...
class InvoiceAutomation:
    ...
    def __init__(self):
        ...
        self.payment_methods = {
            'Main Bank' : {
                'Recipient': 'NeuralNine Company',
                'Bank': 'Hello World Bank',
                'IBAN': 'XY12 3452 3456 7890',
                'BIC': 'ABCDEFGH'
            },
            'Second Bank' : {
                'Recipient': 'NeuralNine Company',
            ...
            'Private Bank' : {
                'Recipient': 'Florian Dedov',
                'Bank': 'Normal Person Bank',
                'IBAN': 'NP12 3452 4578 5986',
                'BIC': 'JIFRYTUGJ'
            }
        }
    ...
    def create_invoice(self):
        doc = docx.Document('invoice-template.docx')
        ...
        subprocess.run([
            'libreoffice', '--headless', '--convert-to', 'pdf', 'filled.docx', '--outdir', '.'
        ], check=True)
